...
-I$(CY_PSOC_LIB_COMP_FULL)/devices/include\
-I$(CY_PSOC_LIB_COMP_FULL)/devices/bsp/COMPONENT_MTB/startup\
-I$(CY_PSOC_LIB_COMP_FULL)/drivers/include
ifeq ($(TOOLCHAIN),ARMCC)
$(PSOC6_PDL_NAME)_LOCAL_DEFINES=
else
$(PSOC6_PDL_NAME)_LOCAL_DEFINES=-DCY_DEVICE_COMMON
endif

ifeq ($(TOOLCHAIN),GCC)
PDL_SSRC = ./TOOLCHAIN_GCC_ARM/cy_syslib_gcc.S
else
ifeq ($(TOOLCHAIN),IAR)
PDL_SSRC = ./TOOLCHAIN_IAR/cy_syslib_iar.s
else
ifeq ($(TOOLCHAIN),ARMCC)
PDL_SSRC = ./TOOLCHAIN_ARM/cy_syslib_mdk.s
endif
endif
endif
