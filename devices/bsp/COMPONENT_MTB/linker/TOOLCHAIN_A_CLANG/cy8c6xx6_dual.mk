...
export TEXT_SIZE_CM0P     := 0x00040000
export RAM_BASE_CM0P      := 0x080000C0
export RAM_SIZE_CM0P      := 0x00010000
...
export VECT_BASE_CM4     := 0x10040000
export RAM_VECT_BASE_CM4 := 0x08010000
export VECT_SIZE_CM4     := 0x0000028C
export TEXT_BASE_CM4     := 0x1004028C
export TEXT_SIZE_CM4     := 0x00040000
export RAM_BASE_CM4      := 0x0801028C
export RAM_SIZE_CM4      := 0x0000F800
