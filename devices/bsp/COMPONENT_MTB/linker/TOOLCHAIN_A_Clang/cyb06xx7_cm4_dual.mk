...
export VECT_BASE_CM0P     := 0x100D0000
export RAM_VECT_BASE_CM0P := 0x08020000
export VECT_SIZE_CM0P     := 0x000000C0
export TEXT_BASE_CM0P     := 0x100D00C0
export TEXT_SIZE_CM0P     := 0x00030000
export RAM_BASE_CM0P      := 0x080200C0
export RAM_SIZE_CM0P      := 0x00027800
...
export VECT_BASE_CM4     := 0x10000400
export RAM_VECT_BASE_CM4 := 0x08000000
export VECT_SIZE_CM4     := 0x0000028C
export TEXT_BASE_CM4     := 0x1000068C
export TEXT_SIZE_CM4     := 0x000CFC00
export RAM_BASE_CM4      := 0x0800028C
export RAM_SIZE_CM4      := 0x00020000
